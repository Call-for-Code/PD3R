...
Fork the project [on GitHub](https://github.com/Build-Change/call_for_code) and clone your fork
locally.

```text
$ git clone git@github.com:username/call_for_code.git
$ cd owl
$ git remote add upstream https://github.com/Build-Change/call_for_code.git
$ git fetch upstream
```
...
your changes to you in the `AUTHORS.md` file and the changelog.
...
Fixes: https://github.com/Build-Change/call_for_code/issues/1337
...
This ensures that your working branch has the latest changes from `Build-Change/call_for_code`
master.
