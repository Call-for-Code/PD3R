...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `Build-Change/call_for_code` in a concrete and reviewable manner.

## Asking for General Help

The best place to ask for help is through GitHub issues.

## Discussing non-technical topics

Discussion of non-technical topics are also best to discuss in GitHub issues.

## Submitting a Bug Report

When opening a new issue in the `Build-Change/call_for_code` issue tracker, please provide as much
